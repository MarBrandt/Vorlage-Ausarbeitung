...
\newcommand*{\myinstitute}{Hochschue Flensburg} % Institut
\newcommand*{\myfaculty}{Fachbereich 1: \textit{Musterstudiengang}} % Weitere Hinweise
\newcommand*{\myauthor}{Max Mustermann} % Autoren
\newcommand*{\myreporttype}{Abschlussarbeit} % Bericht-Typ
\newcommand*{\mygraduation}{Master of Engineering} % Vollständige Anschrift
\newcommand*{\firstexaminer}{Prof. Dr.-Ing. Max Mustermann} % Ort
\newcommand*{\secondexaminer}{Prof. Dr.-Ing. Maxima Musterfrau} % Ort
