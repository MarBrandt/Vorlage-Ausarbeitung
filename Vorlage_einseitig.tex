%Dokumentklasse
\documentclass[a4paper,12pt,makeidx,numbers=noenddot]{scrreprt}
...
\bibliographystyle{myabbrvnat}			% Eigener Stil - Diese Datei im Ordner behalten
...
\rfoot{}
%% 
\renewcommand{\headrulewidth}{0.4pt}					% Linienbreite oben und unten
...
\hyphenation{Um-ge-bungs-tem-pe-ra-tur Um-ge-bungs-tem-pe-ra-tur-en Rauch-gas-tem-pe-ra-tur Aus-tritts-tem-pe-ra-tur Kom-pres-sions-wär-me-pum-pe}
...
\begin{acronym}[4GDH]	% Längste Abkürzung des Verzeichnisses
...
\lhead{}
\rhead{\leftmark}
\addcontentsline{toc}{chapter}{Literaturverzeichnis}		% Fügt das Literaturverzeichnis hinzu
\bibliography{LiteraturDB}

\appendix			% Beginnt den Anhang, sofern ein Anhang benötigt wird
\include{src/anhang}
